...
public class CriaturaAncestralTest {
	...
	@Test
	public void testEntrenarExtremoConMaestria40() {
		criatura = new CriaturaAncestral("Test", 150, AfinidadElemental.FUEGO);
	...
	@Test
	public void testEntrenarNoExtremoConMaestria39() {
		criatura = new CriaturaAncestral("Test", 150, AfinidadElemental.AGUA);
		int nivelMaestria = 39;
